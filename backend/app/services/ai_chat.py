...
FALLBACK_RESPONSES = {
    ...
    "packing": "คำแนะนำทั่วไป: แบ่งของเป็นหมวดหมู่ (เสื้อผ้า, ของใช้ส่วนตัว, เอกสาร, ยา) แล้วเช็ครายการก่อนออกเดินทางครับ",
    "default": "สวัสดีครับ! ผมคือ Pack&Glow AI พร้อมช่วยคุณวางแผนท่องเที่ยว — ถามเรื่องสถานที่, การจัดกระเป๋า, อาหาร หรือสภาพอากาศได้เลยครับ",
}
